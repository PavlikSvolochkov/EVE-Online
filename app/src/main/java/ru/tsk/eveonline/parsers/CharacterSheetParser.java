...
import ru.tsk.eveonline.logic.Character;
import ru.tsk.eveonline.logic.JumpClone;
import ru.tsk.eveonline.logic.JumpCloneImplant;
...
public class CharacterSheetParser extends DefaultHandler {
    ...
    public void parseDocument() {
        ...
        try {
            ...
            Log.d("CharacterSheetParser", e.getMessage());
        }
    }
